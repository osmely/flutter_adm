...
public class SampleADMMessageHandlerJobBase extends ADMMessageHandlerJobBase
{
    ...
    protected void onMessage(final Context context, final Intent intent)
    {
        ...
        final String msgKey = context.getString(context.getResources().getIdentifier("json_data_msg_key", "string", context.getPackageName())); //context.getString(R.string.json_data_msg_key);
